$(function(){
    ...
    $('#add_discount').validate({
        rules: {
            ...
            discount_end_date: {required: true},
        },
        messages: {
            name: {required: "Please Enter Discount Name"},
            code: {required: "Please Enter Discount Code","remote": "This code is already taken",},
            discount: {
                required: "Discount value is required for percentage discount type",
                numeric: "Discount value must be numeric",
                min: "Discount value must be at least 1 for percentage discount type",
                max: "Discount value must be at most 99 for percentage discount type"
            },
            discount_type: {required: "Please select discount type"},
            discount_start_date: {required: "Please enter the start date"},
            discount_end_date: {required: "Please enter the end date"},
        },
        submitHandler: function(form){
            var url = $('.url').val();
            var formdata = new FormData(form);
    ...
    // ========================================
    // script for update Discount
    // ========================================

    $('#update_discount').validate({
        rules: {
            name: {required: true, maxlength: 50},
            code: {required: true, maxlength: 20,
                remote: {
    ...
    // ========================================
    // script for Delete Discount
    // ========================================
    $(document).on("click", ".delete-discount", function(){
        destroy_data($(this),'discount/')
    });
