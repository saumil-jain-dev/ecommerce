            ...
            <div class="home-slide-cover mt-30">
                <div class="hero-slider-1 style-4 dot-style-1 dot-style-1-position-1">
                    <div class="single-hero-slider single-animation-wrap"
                        style="background-image: url({{ asset('public/asset/imgs/slider/slider3_1.webp)') }}">
                    ...
                    <div class="single-hero-slider single-animation-wrap"
                        style="background-image: url({{ asset('public/asset/imgs/slider/slider1_1.webp)') }}">
                        <div class="slider-content">
                            <h1 class="display-2 mb-40">
                                Fresh Spices<br />
                                Big discount
                ...
                <div class="carausel-10-columns" id="carausel-10-columns">
                    <div class="card-2 bg-9 wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href='shop-grid-right.html'><img src="{{ asset('public/asset/imgs/shop/cat-13.png') }}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href='shop-grid-right.html'><img src="{{ asset('public/asset/imgs/shop/cat-12.png') }}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href='shop-grid-right.html'><img src="{{ asset('public/asset/imgs/shop/cat-11.png') }}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href='shop-grid-right.html'><img src="{{ asset('public/asset/imgs/shop/cat-9.png') }}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-13 wow animate__animated animate__fadeInUp" data-wow-delay=".5s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href='shop-grid-right.html'><img src="{{ asset('public/asset/imgs/shop/cat-3.png') }}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-15 wow animate__animated animate__fadeInUp" data-wow-delay=".7s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href='shop-grid-right.html'><img src="{{ asset('public/asset/imgs/shop/cat-2.png') }}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay=".8s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href='shop-grid-right.html'><img src="{{ asset('public/asset/imgs/shop/cat-4.png') }}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-10 wow animate__animated animate__fadeInUp" data-wow-delay=".9s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href='shop-grid-right.html'><img src="{{ asset('public/asset/imgs/shop/cat-5.png') }}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-12 wow animate__animated animate__fadeInUp" data-wow-delay="1s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href='shop-grid-right.html'><img src="{{ asset('public/asset/imgs/shop/cat-14.png') }}" alt="" /></a>
                        </figure>
                    ...
                    <div class="card-2 bg-11 wow animate__animated animate__fadeInUp" data-wow-delay="0s">
                        <figure class="img-hover-scale overflow-hidden">
                            <a href='shop-grid-right.html'><img src="{{ asset('public/asset/imgs/shop/cat-15.png') }}" alt="" /></a>
                        </figure>
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay="0">
                        <img src="assets/imgs/banner/cardemom.jpg" alt="" />
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="banner-img wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                        <img src="assets/imgs/banner/nutmeg.jpg" alt="" />
                        <div class="banner-text">
                            <h4>
                ...
                <div class="col-lg-4 d-md-none d-lg-flex">
                    <div class="banner-img mb-sm-0 wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                        <img src="assets/imgs/banner/turmeric-powder.webp" alt="" />
                        <div class="banner-text">
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/black-cardamon.webp"
                                                alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/blac" alt="" />
                                        </a>
                                    </div>
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/pipali.webp" alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/black-cardamon-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/rosehip-berris.webp"
                                                alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/rosehip-berris-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/red-chillies.webp"
                                                alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/red-chillies-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/star.webp" alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/star-powder.webp" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label='Add To Wishlist' class='action-btn'
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/green-pappercorn.webp"
                                                alt="" />
                                            <img class="hover-img"
                                                src="assets/imgs/shop/green-pappercorn-powder.webp" alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                        <a aria-label='Add To Wishlist' class='action-btn'
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/saffron.webp" alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/saffron-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/black-seasame.webp"
                                                alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/black-seasame-crushed.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-none d-xl-block">
                            <div class="product-cart-wrap wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/Fennel-seeds.webp"
                                                alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/Fennel-seeds-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30 wow animate__animated animate__fadeIn"
                                ...
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/black-mustared.webp"
                                                alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/black-mustared-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/cubeb-peppar.webp"
                                                alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/cubeb-peppar-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/fenugreak-dal.webp"
                                                alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/fenugreak-dal-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/nutmeg.webp" alt="" />
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6 d-none d-xl-block">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/pimento.webp" alt="" />
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/white-mustard.webp"
                                                alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/white-mustard-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/dill-seeds.webp"
                                                alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/dill-seeds-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                        ...
                        <div class="col-lg-1-5 col-md-4 col-12 col-sm-6">
                            <div class="product-cart-wrap">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/coriander.webp" alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/coriander-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/pimento.webp" alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/pimento-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                            ...
                            <div class="product-cart-wrap mb-30">
                                <div class="product-img-action-wrap">
                                    <div class="product-img product-img-zoom">
                                        <a href='shop-product-right.html'>
                                            <img class="default-img" src="assets/imgs/shop/nutmeg.webp" alt="" />
                                            <img class="hover-img" src="assets/imgs/shop/nutmeg-powder.webp"
                                                alt="" />
                                        </a>
                                    </div>
                                    <div class="product-action-1">
                                ...
                                <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns">
                                            ...
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img"
                                                        src="assets/imgs/shop/black-cardamon.webp" alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/black-cardamon-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img" src="assets/imgs/shop/coriander.webp"
                                                        alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/coriander-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img"
                                                        src="assets/imgs/shop/cubeb-peppar.webp" alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/cubeb-peppar-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                            ...
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img" src="assets/imgs/shop/dill-seeds.webp"
                                                        alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/dill-seeds-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img"
                                                        src="assets/imgs/shop/Fennel-seeds.webp" alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/Fennel-seeds-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                ...
                                <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns-2">
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img"
                                                        src="assets/imgs/shop/black-mustared.webp" alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/black-mustared-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img"
                                                        src="assets/imgs/shop/fenugreak-dal.webp" alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/fenugreak-dal-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img"
                                                        src="assets/imgs/shop/green-pappercorn.webp" alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/green-pappercorn-powder.webp"
                                                        alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img" src="assets/imgs/shop/nutmeg.webp"
                                                        alt="" />
                                                    <img class="hover-img" src="assets/imgs/shop/nutmeg-powder.webp"
                                                        alt="" />
                                                </a>
                                ...
                                <div class="carausel-4-columns carausel-arrow-center" id="carausel-4-columns-3">
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img"
                                                        src="assets/imgs/shop/black-seasame.webp" alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/black-seasame-crushed.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img" src="assets/imgs/shop/pimento.webp"
                                                        alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/pimento-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img"
                                                        src="assets/imgs/shop/red-chillies.webp" alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/red-chillies-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img" src="assets/imgs/shop/red-peprika.webp"
                                                        alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/red-peprika-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                                    ...
                                    <div class="product-cart-wrap">
                                        <div class="product-img-action-wrap">
                                            <div class="product-img product-img-zoom">
                                                <a href='shop-product-right.html'>
                                                    <img class="default-img"
                                                        src="assets/imgs/shop/rosehip-berris.webp" alt="" />
                                                    <img class="hover-img"
                                                        src="assets/imgs/shop/rosehip-berris-powder.webp" alt="" />
                                                </a>
                                            </div>
                                            <div class="product-action-1">
                                                <a aria-label="Quick view" class="action-btn small hover-up"
                    ...
                    <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img">
                                <a href='shop-product-right.html'>
                                    <img src="assets/imgs/banner/garam-masala.webp" alt="" />
                                </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6">
                    <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img">
                                <a href='shop-product-right.html'>
                                    <img src="assets/imgs/banner/musturds-seeds.webp" alt="" />
                                </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 d-none d-lg-block">
                    <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img">
                                <a href='shop-product-right.html'>
                                    <img src="assets/imgs/banner/spicy-masala.webp" alt="" />
                                </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 d-none d-xl-block">
                    <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp"
                        ...
                        <div class="product-img-action-wrap">
                            <div class="product-img">
                                <a href='shop-product-right.html'>
                                    <img src="assets/imgs/banner/herbs-masala.webp" alt="" />
                                </a>
                            </div>
                        </div>
                        <div class="product-content-wrap">
            ...
            <div class="row">
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/barberry.webp"
                                        alt="" /></a>
                            </figure>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/coriander.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/cubeb-peppar.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-md-0 wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/black-cardamon.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/dill-seeds.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/Fennel-seeds.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-lg-block wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/black-mustared.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/white-mustard.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/star.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                ...
                <div class="col-xl-3 col-lg-4 col-md-6 mb-sm-5 mb-md-0 d-none d-xl-block wow animate__animated animate__fadeInUp"
                    ...
                    <div class="product-list-small animated animated">
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/black-seasame.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/seasame-seeds.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
                        ...
                        <article class="row align-items-center hover-up">
                            <figure class="col-md-4 mb-0">
                                <a href='shop-product-right.html'><img src="assets/imgs/shop/saffron.webp"
                                        alt="" /></a>
                            </figure>
                            <div class="col-md-8 mb-0">
                                <h6>
