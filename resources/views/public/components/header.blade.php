...
<!-- Mirrored from nest-frontend-v6.netlify.app/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Apr 2024 14:36:58 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <!-- Favicon -->
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('public/asset/imgs/theme/favicon.svg') }}" />
    <!-- Template CSS -->
    <link rel="stylesheet" href="{{ asset('public/asset/css/plugins/animate.min.css') }}" />
    <link rel="stylesheet" href="{{ asset('public/asset/css/main5103.css') }} " />
</head>
<body>
        <!-- Quick view -->
                            ...
                            <div class="detail-gallery">
                                ...
                                <div class="product-image-slider">
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/asset/imgs/shop/product-16-2.jpg') }}" alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/asset/imgs/shop/product-16-1.jpg') }}" alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/asset/imgs/shop/product-16-3.jpg') }}" alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/asset/imgs/shop/product-16-4.jpg') }}" alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/asset/imgs/shop/product-16-5.jpg') }}" alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/asset/imgs/shop/product-16-6.jpg') }}" alt="product image" />
                                    </figure>
                                    <figure class="border-radius-10">
                                        <img src="{{ asset('public/asset/imgs/shop/product-16-7.jpg') }}" alt="product image" />
                                    </figure>
                                </div>
                                <!-- THUMBNAILS -->
                                <div class="slider-nav-thumbnails">
                                    <div><img src="{{ asset('public/asset/imgs/shop/thumbnail-3.jpg') }}" alt="product image" /></div>
                                    <div><img src="{{ asset('public/asset/imgs/shop/thumbnail-4.jpg') }}" alt="product image" /></div>
                                    <div><img src="{{ asset('public/asset/imgs/shop/thumbnail-5.jpg') }}" alt="product image" /></div>
                                    <div><img src="{{ asset('public/asset/imgs/shop/thumbnail-6.jpg') }}" alt="product image" /></div>
                                    <div><img src="{{ asset('public/asset/imgs/shop/thumbnail-7.jpg') }}" alt="product image" /></div>
                                    <div><img src="{{ asset('public/asset/imgs/shop/thumbnail-8.jpg') }}" alt="product image" /></div>
                                    <div><img src="{{ asset('public/asset/imgs/shop/thumbnail-9.jpg') }}" alt="product image" /></div>
                                </div>
                            </div>
                            <!-- End Gallery -->
                        </div>
                            ...
                            <div class="header-action-2">
                                ...
                                <div class="header-action-icon-2">
                                    <!-- <a href='shop-compare.html'>
                                        <img class="svgInject" alt="Nest"
                                            src="{{ asset('public/asset/imgs/theme/icons/icon-compare.svg') }}" />
                                ...
                                <div class="header-action-icon-2">
                                    <a href='shop-wishlist.html'>
                                        <img class="svgInject" alt="Nest"
                                            src="{{ asset('public/asset/imgs/theme/icons/icon-heart.svg') }}" />
                                ...
                                <div class="header-action-icon-2">
                                    <a class='mini-cart-icon' href='shop-cart.html'>
                                        <img alt="Nest" src="{{ asset('public/asset/imgs/theme/icons/icon-cart.svg') }}" />
                                    ...
                                    <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                        <ul>
                                            ...
                                            <li>
                                                <div class="shopping-cart-img">
                                                    <a href='shop-product-right.html'><img alt="Nest"
                                                            src="{{ asset('public/asset/imgs/shop/thumbnail-2.jpg') }}" /></a>
                                                </div>
                                                <div class="shopping-cart-title">
                                ...
                                <div class="header-action-icon-2">
                                    <a href='page-account.html'>
                                        <img class="svgInject" alt="Nest" src="{{ asset('public/asset/imgs/theme/icons/icon-user.svg') }}" />
                                    </a>
            ...
            <div class="container">
                <div class="header-wrap header-space-between position-relative">
                    <div class="logo logo-width-1 d-block d-lg-none">
                        <a href='index.html'><img src="{{ asset('public/asset/imgs/theme/logo.svg') }}" alt="logo" /></a>
                    </div>
                    <div class="header-nav d-none d-lg-flex">
                                    ...
                                    <ul>
                                        <li>
                                            <a href='shop-grid-right.html'> <img
                                                    src="{{ asset('public/asset/imgs/theme/icons/category-1.svg') }}" alt="" />Milks and
                                                Dairies</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img
                                                    src="{{ asset('public/asset/imgs/theme/icons/category-2.svg') }}" alt="" />Clothing &
                                                beauty</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img
                                                    src="{{ asset('public/asset/imgs/theme/icons/category-3.svg') }}" alt="" />Pet Foods &
                                                Toy</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img
                                                    src="{{ asset('public/asset/imgs/theme/icons/category-4.svg') }}" alt="" />Baking
                                                material</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img
                                                    src="{{ asset('public/asset/imgs/theme/icons/category-5.svg') }}" alt="" />Fresh
                                                Fruit</a>
                                        </li>
                                    </ul>
                                    <ul class="end">
                                        <li>
                                            <a href='shop-grid-right.html'> <img
                                                    src="{{ asset('public/asset/imgs/theme/icons/category-6.svg') }}" alt="" />Wines &
                                                Drinks</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img
                                                    src="{{ asset('public/asset/imgs/theme/icons/category-7.svg') }}" alt="" />Fresh
                                                Seafood</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img
                                                    src="{{ asset('public/asset/imgs/theme/icons/category-8.svg') }}" alt="" />Fast food</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img
                                                    src="{{ asset('public/asset/imgs/theme/icons/category-9.svg') }}" alt="" />Vegetables</a>
                                        </li>
                                        <li>
                                            <a href='shop-grid-right.html'> <img
                                                    src="{{ asset('public/asset/imgs/theme/icons/category-10.svg') }}" alt="" />Bread and
                                                Juice</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="more_slide_open" style="display: none">
                                    <div class="d-flex categori-dropdown-inner">
                                        <ul>
                                            <li>
                                                <a href='shop-grid-right.html'> <img
                                                        src="{{ asset('public/asset/imgs/theme/icons/icon-1.svg') }}" alt="" />Milks and
                                                    Dairies</a>
                                            </li>
                                            <li>
                                                <a href='shop-grid-right.html'> <img
                                                        src="{{ asset('public/asset/imgs/theme/icons/icon-2.svg') }}" alt="" />Clothing &
                                                    beauty</a>
                                            </li>
                                        </ul>
                                        <ul class="end">
                                            <li>
                                                <a href='shop-grid-right.html'> <img
                                                        src="{{ asset('public/asset/imgs/theme/icons/icon-3.svg') }}" alt="" />Wines &
                                                    Drinks</a>
                                            </li>
                                            <li>
                                                <a href='shop-grid-right.html'> <img
                                                        src="{{ asset('public/asset/imgs/theme/icons/icon-4.svg') }}" alt="" />Fresh
                                                    Seafood</a>
                                            </li>
                                        </ul>
                                    </div>
                        ...
                        <div class="main-menu main-menu-padding-1 main-menu-lh-2 d-none d-lg-block font-heading">
                            <nav>
                                <ul>
                                    <li class="hot-deals"><img src="{{ asset('public/asset/imgs/theme/icons/icon-hot.svg') }}"
                                            ...
                                            <li class="sub-mega-menu sub-mega-menu-width-34">
                                                <div class="menu-banner-wrap">
                                                    <a href='shop-product-right.html'><img
                                                            src="{{ asset('public/asset/imgs/banner/banner-menu.png') }}" alt="Nest" /></a>
                    ...
                    <div class="header-action-right d-block d-lg-none">
                        <div class="header-action-2">
                            <div class="header-action-icon-2">
                                <a href='shop-wishlist.html'>
                                    <img alt="Nest" src="{{ asset('public/asset/imgs/theme/icons/icon-heart.svg') }}" />
                                ...
                                <div class="cart-dropdown-wrap cart-dropdown-hm2">
                                    <ul>
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href='shop-product-right.html'><img alt="Nest"
                                                        src="{{ asset('public/asset/imgs/shop/thumbnail-3.jpg') }}" /></a>
                                            </div>
                                            <div class="shopping-cart-title">
                                        ...
                                        <li>
                                            <div class="shopping-cart-img">
                                                <a href='shop-product-right.html'><img alt="Nest"
                                                        src="{{ asset('public/asset/imgs/shop/thumbnail-4.jpg') }}" /></a>
                                            </div>
                                            <div class="shopping-cart-title">
