                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post" id="EditProfile">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4">
                                                        <input type="submit" class="btn btn-fill-out submit font-weight-bold" name="submit" value="Save Changes">
                                                    </div>
                                               	</form>
                                               	<form id="changepassword" method="post">
                                                    ...
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <input required="" class="form-control" name="new_pass" type="password" id="new_pass" />
                                                    </div>
                                                    <div class="form-group col-md-12">
                                                        <label>Confirm Password <span class="required">*</span></label>
                                                        <input required="" class="form-control" name="re_pass" type="password" />
                                                    </div>
                                                    <div class="col-md-4">
                                                        <input type="submit" class="btn btn-fill-out submit font-weight-bold" name="submit" value="Change">
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
